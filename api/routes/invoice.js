...
const { add, fetchInvoices, update, monthlySalesReport, getInvoicesForSizesSalesReport, getRolling12MonthComparison } = require("../../controller/invoice");
const { FETCH_INVOICES, SAVE_INVOICE, UPDATE_INVOICE, MONTHLY_SALES_REPORT, FETCH_SIZES_SALES_REPORT, ROLLING_12_MONTH_COMPARISON } =
